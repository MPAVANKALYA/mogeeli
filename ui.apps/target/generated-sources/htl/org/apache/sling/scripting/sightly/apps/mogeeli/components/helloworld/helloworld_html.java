 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.mogeeli.components.helloworld;
...
out.write("\r\n    ");
_global_model = renderContext.call("use", com.mogeeli.core.models.HelloWorldModel.class.getName(), obj());
{
